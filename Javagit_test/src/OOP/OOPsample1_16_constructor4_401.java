...
public class OOPsample1_16_constructor4_401 {
	 ...
	 private static int n;//0 => 5
	   ...
	   public OOPsample1_16_constructor4_401(int n, double[] number) {
	   ...
	   public static void main(String[] args) {
	      ...
	      System.out.println("입력받아서 처리할 데이터의 갯수는 ?");
	       ...
	       OOPsample1_16_constructor4_401 oop16_4 = new OOPsample1_16_constructor4_401(n, number);
