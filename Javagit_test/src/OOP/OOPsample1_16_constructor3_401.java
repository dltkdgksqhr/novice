 ...
 *  생성자가 1개밖에 없기때문에 오버로딩 아님

 */
public class OOPsample1_16_constructor3_401 {
	 ...
	 private static double x;//0.0 => 50.123
	   ...
	   public OOPsample1_16_constructor3_401(double x, int y) {
	   ...
	   public static void main(String[] args) {
	      ...
	      OOPsample1_16_constructor3_401 oop16_3 =  new OOPsample1_16_constructor3_401(x, y);
