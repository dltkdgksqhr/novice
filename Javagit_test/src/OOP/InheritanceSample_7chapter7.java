...
public class InheritanceSample_7chapter7{

 
	public static void main(String[] args) {
		InheritanceSample_7chapter7 is7 = new InheritanceSample_7chapter7();

		 

		Ant p22 = new Ant(); //객체생성[O]
